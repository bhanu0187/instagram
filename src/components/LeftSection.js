    ...
    <div className=" w-2/3 md:flex md:justify-center md:items-center h-screen bg-white md:bg-transparent border-r-2 border-white flex flex-col justify-start items-center">
      <div className="p-4">
        ...
        <div className="text-white text-sm space-y-4">
          <button
            type="button"
            className="flex items-center space-x-2 py-2 px-4 rounded-lg hover:text-gray-600"
          >
        ...
        <div>
          <button
            type="button"
            className="flex items-center space-x-2 py-2 px-4 rounded-lg mt-28 dropdown dropdown-end dropdown-right"
          >
            <label tabIndex={0} className="flex items-center space-x-2">
